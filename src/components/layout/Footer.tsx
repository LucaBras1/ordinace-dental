...
const footerLinks = {
  quickLinks: [
    { name: 'Objednat se', href: '/objednavka' },
    { name: 'O nás', href: '/o-nas' },
    { name: 'Kontakt', href: '/kontakt' },
    { name: 'Ceník', href: '/cenik' },
  ],
  services: [
    { name: 'Dentální hygiena', href: '/sluzby/dentalni-hygiena' },
    { name: 'Bělení zubů', href: '/sluzby/beleni-zubu' },
    { name: 'Air-Flow', href: '/sluzby/air-flow' },
    { name: 'Parodontologie', href: '/sluzby/parodontologie' },
  ],
  info: [
    { name: 'FAQ', href: '/faq' },
      ...
      <div className="container-custom py-12 lg:py-16">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-4 text-sm text-gray-600">
              Profesionální péče o vaše zuby s moderním vybavením a laskavým
              přístupem.
            </p>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-gray-200 pt-8 md:flex-row">
          <p className="text-sm text-gray-500">
            &copy; {new Date().getFullYear()} Dentální Hygiena. Všechna práva
            vyhrazena.
          </p>
